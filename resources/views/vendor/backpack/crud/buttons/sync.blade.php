@if ($crud->hasAccess('update'))
	<a href="javascript:void(0)" onclick="syncData(this)" data-route="{{ url($crud->route.'/'.$entry->getKey().'/syncdata') }}" class="btn btn-sm btn-link" data-button-type="sync"><i class="la la-trash"></i> Get Data from Kobo</a>
@endif

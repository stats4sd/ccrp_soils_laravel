...
@section('content')
	...
	@else 
		<div class="alert alert-danger alert-block" id="danger"><p><b>You are not register.</b> Before to continue you must <a href="{{URL::to('en/'.$key_confirm.'/register')}}">register.</a></p></div>

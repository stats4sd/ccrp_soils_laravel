...
@section('content')
	...
	@else 
		<div class="alert alert-danger alert-block" id="danger"><p><b>{{ t("You are not register.) }}</b>  {{ t("Before to continue you must") }} <a href="{{URL::to('en/'.$key_confirm.'/register')}}"> {{ t("register.2) }}</a></p></div>
